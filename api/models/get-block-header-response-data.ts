 ...
 *
 * @export
 * @interface GetBlockHeaderResponseData
 */
export interface GetBlockHeaderResponseData {

    /**
     * @type {any}
     * @memberof GetBlockHeaderResponseData
     ...
     * @memberof GetBlockHeaderResponseData
     */
    header: Ethv1beaconpoolproposerSlashingsSignedHeader1;
}
