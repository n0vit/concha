 ...
 *
 * @export
 * @interface GetStateFinalityCheckpointsResponseData
 */
export interface GetStateFinalityCheckpointsResponseData {

    /**
     * @type {Ethv1beaconpoolattesterSlashingsAttestation1DataSource}
     * @memberof GetStateFinalityCheckpointsResponseData
     */
    previousJustified: Ethv1beaconpoolattesterSlashingsAttestation1DataSource;

    /**
     * @type {Ethv1beaconpoolattesterSlashingsAttestation1DataSource}
     * @memberof GetStateFinalityCheckpointsResponseData
     */
    currentJustified: Ethv1beaconpoolattesterSlashingsAttestation1DataSource;

    /**
     * @type {Ethv1beaconpoolattesterSlashingsAttestation1DataSource}
     * @memberof GetStateFinalityCheckpointsResponseData
     */
    finalized: Ethv1beaconpoolattesterSlashingsAttestation1DataSource;
}
