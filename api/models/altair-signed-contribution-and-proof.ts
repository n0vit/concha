...
import { AltairSignedContributionAndProofMessage } from './altair-signed-contribution-and-proof-message';
 /**
 * 
 *
 * @export
 * @interface AltairSignedContributionAndProof
 */
export interface AltairSignedContributionAndProof {

    /**
     * @type {AltairSignedContributionAndProofMessage}
     * @memberof AltairSignedContributionAndProof
     */
    message: AltairSignedContributionAndProofMessage;
