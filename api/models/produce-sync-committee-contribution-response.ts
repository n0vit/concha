 ...
 *
 * @export
 * @interface ProduceSyncCommitteeContributionResponse
 */
export interface ProduceSyncCommitteeContributionResponse {

    /**
     * @type {AltairContributionAndProofContribution}
     * @memberof ProduceSyncCommitteeContributionResponse
     */
    data: AltairContributionAndProofContribution;
}
