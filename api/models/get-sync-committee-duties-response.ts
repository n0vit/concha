 ...
 *
 * @export
 * @interface GetSyncCommitteeDutiesResponse
 */
export interface GetSyncCommitteeDutiesResponse {
  /**
   * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
   *
   * @type {any}
   * @memberof GetSyncCommitteeDutiesResponse
   * @example false
   */
  ...
  data: Array<{
    ...
    validator_sync_committee_indices: Array<string>;
  }>;
}
