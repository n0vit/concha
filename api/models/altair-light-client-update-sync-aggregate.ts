 ...
 *
 * @export
 * @interface AltairLightClientUpdateSyncAggregate
 */
export interface AltairLightClientUpdateSyncAggregate {

    /**
     * Aggregation bits of sync
     *
     * @type {any}
     * @memberof AltairLightClientUpdateSyncAggregate
     * @example 0x01
     */
    syncCommitteeBits: any;
