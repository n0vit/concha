 ...
 *
 * @export
 * @interface AltairLightClientBootstrapCurrentSyncCommittee
 */
export interface AltairLightClientBootstrapCurrentSyncCommittee {

    /**
     * @type {any}
     * @memberof AltairLightClientBootstrapCurrentSyncCommittee
     */
    pubkeys: any;
