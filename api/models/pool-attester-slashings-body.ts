...
import { Ethv1beaconpoolattesterSlashingsAttestation1 } from './ethv1beaconpoolattester-slashings-attestation1';
 /**
 ...
 *
 * @export
 * @interface PoolAttesterSlashingsBody
 */
export interface PoolAttesterSlashingsBody {

    /**
     * @type {Ethv1beaconpoolattesterSlashingsAttestation1}
     * @memberof PoolAttesterSlashingsBody
     */
    attestation1: Ethv1beaconpoolattesterSlashingsAttestation1;

    /**
     * @type {Ethv1beaconpoolattesterSlashingsAttestation1}
     * @memberof PoolAttesterSlashingsBody
     */
    attestation2: Ethv1beaconpoolattesterSlashingsAttestation1;
}
