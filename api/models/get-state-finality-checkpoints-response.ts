...
import { GetStateFinalityCheckpointsResponseData } from './get-state-finality-checkpoints-response-data';
 /**
 * 
 *
 * @export
 * @interface GetStateFinalityCheckpointsResponse
 */
export interface GetStateFinalityCheckpointsResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetStateFinalityCheckpointsResponse
     * @example false
     */
    ...
    /**
     * @type {GetStateFinalityCheckpointsResponseData}
     * @memberof GetStateFinalityCheckpointsResponse
     */
