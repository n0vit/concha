...
import { Ethv1beaconpoolproposerSlashingsSignedHeader1 } from './ethv1beaconpoolproposer-slashings-signed-header1';
 /**
 ...
 *
 * @export
 * @interface PoolProposerSlashingsBody
 */
export interface PoolProposerSlashingsBody {

    /**
     * @type {Ethv1beaconpoolproposerSlashingsSignedHeader1}
     * @memberof PoolProposerSlashingsBody
     */
    signedHeader1: Ethv1beaconpoolproposerSlashingsSignedHeader1;

    /**
     * @type {Ethv1beaconpoolproposerSlashingsSignedHeader1}
     * @memberof PoolProposerSlashingsBody
     */
    signedHeader2: Ethv1beaconpoolproposerSlashingsSignedHeader1;
}
