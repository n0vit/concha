...
import { AltairContributionAndProofContribution } from './altair-contribution-and-proof-contribution';
 /**
 * 
 *
 * @export
 * @interface AltairSignedContributionAndProofMessage
 */
export interface AltairSignedContributionAndProofMessage {

    /**
     * Index of validator in validator registry.
     *
     * @type {any}
     * @memberof AltairSignedContributionAndProofMessage
     * @example 1
     */
    aggregatorIndex: any;
    ...
    /**
     * @type {AltairContributionAndProofContribution}
     * @memberof AltairSignedContributionAndProofMessage
     */
    contribution: AltairContributionAndProofContribution;
}
