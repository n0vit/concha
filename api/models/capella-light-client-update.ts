...
import { AltairLightClientUpdateSyncAggregate } from './altair-light-client-update-sync-aggregate';
import { CapellaLightClientBootstrapHeader } from './capella-light-client-bootstrap-header';
 /**
 * 
 *
 * @export
 * @interface CapellaLightClientUpdate
 */
export interface CapellaLightClientUpdate {

    /**
     * @type {CapellaLightClientBootstrapHeader}
     * @memberof CapellaLightClientUpdate
     */
    attestedHeader: CapellaLightClientBootstrapHeader;
     ...
     * @memberof CapellaLightClientUpdate
     */
    nextSyncCommitteeBranch: any;

    /**
     * @type {CapellaLightClientBootstrapHeader}
     * @memberof CapellaLightClientUpdate
     */
    finalizedHeader: CapellaLightClientBootstrapHeader;
    ...
    /**
     * @type {AltairLightClientUpdateSyncAggregate}
     * @memberof CapellaLightClientUpdate
     */
    syncAggregate: AltairLightClientUpdateSyncAggregate;
