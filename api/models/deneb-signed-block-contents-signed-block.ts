 ...
 */
 ...
 /**
 * The [`SignedBeaconBlock`](https://github.com/ethereum/consensus-specs/blob/master/specs/deneb/beacon-chain.md#signedbeaconblock) object envelope from the CL Deneb spec.
 *
 * @export
 * @interface DenebSignedBlockContentsSignedBlock
 */
export interface DenebSignedBlockContentsSignedBlock {

    /**
     * The [`BeaconBlock`](https://github.com/ethereum/consensus-specs/blob/master/specs/deneb/beacon-chain.md#beaconblock) object from the CL Deneb spec.
     *
     * @type {any}
     * @memberof DenebSignedBlockContentsSignedBlock
     */
    message: any;
