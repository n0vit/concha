...
import { GetAttestationsRewardsResponseData } from './get-attestations-rewards-response-data';
 /**
 * 
 *
 * @export
 * @interface GetAttestationsRewardsResponse
 */
export interface GetAttestationsRewardsResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetAttestationsRewardsResponse
     * @example false
     */
    ...
    /**
     * @type {GetAttestationsRewardsResponseData}
     * @memberof GetAttestationsRewardsResponse
     */
    data: GetAttestationsRewardsResponseData;
}
