    ...
    return {
        ...
        getAttestationsRewards: async (epoch: any, body?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (epoch === null || epoch === undefined) {
                throw new RequiredError('epoch','Required parameter epoch was null or undefined when calling getAttestationsRewards.');
            }
            const localVarPath = `/eth/v1/beacon/rewards/attestations/{epoch}`
        ...
        getBlockRewards: async (blockId: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (blockId === null || blockId === undefined) {
                throw new RequiredError('blockId','Required parameter blockId was null or undefined when calling getBlockRewards.');
            }
            const localVarPath = `/eth/v1/beacon/rewards/blocks/{block_id}`
         ...
         * @throws {RequiredError}
         */
        getSyncCommitteeRewards: async (blockId: any, body?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'blockId' is not null or undefined
            if (blockId === null || blockId === undefined) {
                throw new RequiredError('blockId','Required parameter blockId was null or undefined when calling getSyncCommitteeRewards.');
            }
            const localVarPath = `/eth/v1/beacon/rewards/sync_committee/{block_id}`
                .replace(`{${"block_id"}}`, encodeURIComponent(String(blockId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const RewardsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAttestationsRewards(epoch: any, body?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetAttestationsRewardsResponse>>> {
            const localVarAxiosArgs = await RewardsApiAxiosParamCreator(configuration).getAttestationsRewards(epoch, body, options);
         ...
         * @throws {RequiredError}
         */
        async getBlockRewards(blockId: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetBlockRewardsResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async getSyncCommitteeRewards(blockId: any, body?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetSyncCommitteeRewardsResponse>>> {
            const localVarAxiosArgs = await RewardsApiAxiosParamCreator(configuration).getSyncCommitteeRewards(blockId, body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RewardsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAttestationsRewards(epoch: any, body?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetAttestationsRewardsResponse>> {
            return RewardsApiFp(configuration).getAttestationsRewards(epoch, body, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve block reward info for a single block
         * @summary Get block rewards
        ...
        async getBlockRewards(blockId: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetBlockRewardsResponse>> {
            return RewardsApiFp(configuration).getBlockRewards(blockId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves rewards info for sync committee members specified by array of public keys or validator index. If no array is provided, return reward info for every committee member.
         * @summary Get sync committee rewards
         ...
         * @throws {RequiredError}
         */
        async getSyncCommitteeRewards(blockId: any, body?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetSyncCommitteeRewardsResponse>> {
            return RewardsApiFp(configuration).getSyncCommitteeRewards(blockId, body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RewardsApi extends BaseAPI {
     ...
     * @memberof RewardsApi
     */
    public async getAttestationsRewards(epoch: any, body?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetAttestationsRewardsResponse>> {
        return RewardsApiFp(this.configuration).getAttestationsRewards(epoch, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve block reward info for a single block
     * @summary Get block rewards
     ...
     * @memberof RewardsApi
     */
    public async getBlockRewards(blockId: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetBlockRewardsResponse>> {
        return RewardsApiFp(this.configuration).getBlockRewards(blockId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves rewards info for sync committee members specified by array of public keys or validator index. If no array is provided, return reward info for every committee member.
     * @summary Get sync committee rewards
     ...
     * @memberof RewardsApi
     */
    public async getSyncCommitteeRewards(blockId: any, body?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetSyncCommitteeRewardsResponse>> {
        return RewardsApiFp(this.configuration).getSyncCommitteeRewards(blockId, body, options).then((request) => request(this.axios, this.basePath));
    }
}
