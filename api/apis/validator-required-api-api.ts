 ...
 * @export
 */
export const ValidatorRequiredApiApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getStateFork: async (stateId: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'stateId' is not null or undefined
            if (stateId === null || stateId === undefined) {
                throw new RequiredError('stateId','Required parameter stateId was null or undefined when calling getStateFork.');
            }
            const localVarPath = `/eth/v1/beacon/states/{state_id}/fork`
         ...
         * @throws {RequiredError}
         */
        getStateValidator: async (stateId: any, validatorId: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'stateId' is not null or undefined
            if (stateId === null || stateId === undefined) {
                throw new RequiredError('stateId','Required parameter stateId was null or undefined when calling getStateValidator.');
            }
            // verify required parameter 'validatorId' is not null or undefined
            if (validatorId === null || validatorId === undefined) {
                throw new RequiredError('validatorId','Required parameter validatorId was null or undefined when calling getStateValidator.');
            }
            const localVarPath = `/eth/v1/beacon/states/{state_id}/validators/{validator_id}`
                .replace(`{${"state_id"}}`, encodeURIComponent(String(stateId)))
         ...
         * @throws {RequiredError}
         */
        publishBlindedBlock: async (body: any, ethConsensusVersion?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling publishBlindedBlock.');
            }
            ...
            if (ethConsensusVersion !== undefined && ethConsensusVersion !== null) {
                localVarHeaderParameter['Eth-Consensus-Version'] = String(JSON.stringify(ethConsensusVersion));
            }
         ...
         * @throws {RequiredError}
         */
        publishBlindedBlockV2: async (body: any, ethConsensusVersion: any, broadcastValidation?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling publishBlindedBlockV2.');
            }
            ...
            if (ethConsensusVersion === null || ethConsensusVersion === undefined) {
                throw new RequiredError('ethConsensusVersion','Required parameter ethConsensusVersion was null or undefined when calling publishBlindedBlockV2.');
            }
         ...
         * @throws {RequiredError}
         */
        publishBlock: async (body: any, ethConsensusVersion?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling publishBlock.');
            }
         ...
         * @throws {RequiredError}
         */
        publishBlockV2: async (body: any, ethConsensusVersion: any, broadcastValidation?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling publishBlockV2.');
            }
            // verify required parameter 'ethConsensusVersion' is not null or undefined
            if (ethConsensusVersion === null || ethConsensusVersion === undefined) {
                throw new RequiredError('ethConsensusVersion','Required parameter ethConsensusVersion was null or undefined when calling publishBlockV2.');
            }
         ...
         * @throws {RequiredError}
         */
        submitPoolAttestations: async (body: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling submitPoolAttestations.');
            }
         ...
         * @throws {RequiredError}
         */
        submitPoolSyncCommitteeSignatures: async (body: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling submitPoolSyncCommitteeSignatures.');
            }
 ...
 * @export
 */
export const ValidatorRequiredApiApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Provides endpoint to subscribe to beacon node Server-Sent-Events stream. Consumers should use [eventsource](https://html.spec.whatwg.org/multipage/server-sent-events.html#the-eventsource-interface) implementation to listen on those events.  Servers _may_ send SSE comments beginning with `:` for any purpose, including to keep the event stream connection alive in the presence of proxy servers. 
         * @summary Subscribe to beacon node events
        ...
        async eventstream(topics: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<any>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).eventstream(topics, options);
        ...
        async getAggregatedAttestation(attestationDataRoot: any, slot: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetAggregatedAttestationResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getAggregatedAttestation(attestationDataRoot, slot, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getAttesterDuties(body: any, epoch: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetAttesterDutiesResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getAttesterDuties(body, epoch, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getGenesis(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetGenesisResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getGenesis(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getProposerDuties(epoch: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetProposerDutiesResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getProposerDuties(epoch, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getSpec(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetSpecResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getSpec(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getStateFork(stateId: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetStateForkResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getStateFork(stateId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getStateValidator(stateId: any, validatorId: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetStateValidatorResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getStateValidator(stateId, validatorId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getSyncCommitteeDuties(body: any, epoch: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetSyncCommitteeDutiesResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getSyncCommitteeDuties(body, epoch, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getSyncingStatus(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GetSyncingStatusResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).getSyncingStatus(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async prepareBeaconCommitteeSubnet(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).prepareBeaconCommitteeSubnet(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async prepareBeaconProposer(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).prepareBeaconProposer(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async prepareSyncCommitteeSubnets(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).prepareSyncCommitteeSubnets(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async produceAttestationData(slot: any, committeeIndex: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ProduceAttestationDataResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).produceAttestationData(slot, committeeIndex, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async produceBlindedBlock(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ProduceBlindedBlockResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).produceBlindedBlock(slot, randaoReveal, graffiti, skipRandaoVerification, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async produceBlockV2(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ProduceBlockV2Response>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).produceBlockV2(slot, randaoReveal, graffiti, skipRandaoVerification, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async produceBlockV3(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, builderBoostFactor?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ProduceBlockV3Response>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).produceBlockV3(slot, randaoReveal, graffiti, skipRandaoVerification, builderBoostFactor, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async produceSyncCommitteeContribution(slot: any, subcommitteeIndex: any, beaconBlockRoot: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ProduceSyncCommitteeContributionResponse>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).produceSyncCommitteeContribution(slot, subcommitteeIndex, beaconBlockRoot, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async publishAggregateAndProofs(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).publishAggregateAndProofs(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async publishBlindedBlock(body: any, ethConsensusVersion?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).publishBlindedBlock(body, ethConsensusVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async publishBlindedBlockV2(body: any, ethConsensusVersion: any, broadcastValidation?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).publishBlindedBlockV2(body, ethConsensusVersion, broadcastValidation, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async publishBlock(body: any, ethConsensusVersion?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).publishBlock(body, ethConsensusVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async publishBlockV2(body: any, ethConsensusVersion: any, broadcastValidation?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).publishBlockV2(body, ethConsensusVersion, broadcastValidation, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async publishContributionAndProofs(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).publishContributionAndProofs(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async submitPoolAttestations(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).submitPoolAttestations(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async submitPoolSyncCommitteeSignatures(body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await ValidatorRequiredApiApiAxiosParamCreator(configuration).submitPoolSyncCommitteeSignatures(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const ValidatorRequiredApiApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Provides endpoint to subscribe to beacon node Server-Sent-Events stream. Consumers should use [eventsource](https://html.spec.whatwg.org/multipage/server-sent-events.html#the-eventsource-interface) implementation to listen on those events.  Servers _may_ send SSE comments beginning with `:` for any purpose, including to keep the event stream connection alive in the presence of proxy servers. 
         * @summary Subscribe to beacon node events
        ...
        async eventstream(topics: any, options?: AxiosRequestConfig): Promise<AxiosResponse<any>> {
            return ValidatorRequiredApiApiFp(configuration).eventstream(topics, options).then((request) => request(axios, basePath));
        },
        /**
         * Aggregates all attestations matching given attestation data root and slot.  A 503 error must be returned if the block identified by the response `beacon_block_root` is optimistic (i.e. the aggregated attestation attests to a block that has not been fully verified by an execution engine).  A 404 error must be returned if no attestation is available for the requested `attestation_data_root`. 
         * @summary Get aggregated attestation
        ...
        async getAggregatedAttestation(attestationDataRoot: any, slot: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetAggregatedAttestationResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getAggregatedAttestation(attestationDataRoot, slot, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests the beacon node to provide a set of attestation duties, which should be performed by validators, for a particular epoch. Duties should only need to be checked once per epoch, however a chain reorganization (of > MIN_SEED_LOOKAHEAD epochs) could occur, resulting in a change of duties. For full safety, you should monitor head events and confirm the dependent root in this response matches: - event.previous_duty_dependent_root when `compute_epoch_at_slot(event.slot) == epoch` - event.current_duty_dependent_root when `compute_epoch_at_slot(event.slot) + 1 == epoch` - event.block otherwise  The dependent_root value is `get_block_root_at_slot(state, compute_start_slot_at_epoch(epoch - 1) - 1)` or the genesis block root in the case of underflow.
         * @summary Get attester duties
        ...
        async getAttesterDuties(body: any, epoch: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetAttesterDutiesResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getAttesterDuties(body, epoch, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve details of the chain's genesis which can be used to identify chain.
         * @summary Retrieve details of the chain's genesis.
         ...
         * @throws {RequiredError}
         */
        async getGenesis(options?: AxiosRequestConfig): Promise<AxiosResponse<GetGenesisResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getGenesis(options).then((request) => request(axios, basePath));
        },
        /**
         * Request beacon node to provide all validators that are scheduled to propose a block in the given epoch. Duties should only need to be checked once per epoch, however a chain reorganization could occur that results in a change of duties. For full safety, you should monitor head events and confirm the dependent root in this response matches: - event.current_duty_dependent_root when `compute_epoch_at_slot(event.slot) == epoch` - event.block otherwise  The dependent_root value is `get_block_root_at_slot(state, compute_start_slot_at_epoch(epoch) - 1)` or the genesis block root in the case of underflow.
         * @summary Get block proposers duties
        ...
        async getProposerDuties(epoch: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetProposerDutiesResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getProposerDuties(epoch, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve specification configuration used on this node.  The configuration should include:   - Constants for all hard forks known by the beacon node, for example the [phase 0](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/phase0/beacon-chain.md#constants) and [altair](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/altair/beacon-chain.md#constants) values   - Presets for all hard forks supplied to the beacon node, for example the [phase 0](https://github.com/ethereum/consensus-specs/blob/v1.3.0/presets/mainnet/phase0.yaml) and [altair](https://github.com/ethereum/consensus-specs/blob/v1.3.0/presets/mainnet/altair.yaml) values   - Configuration for the beacon node, for example the [mainnet](https://github.com/ethereum/consensus-specs/blob/v1.3.0/configs/mainnet.yaml) values  Values are returned with following format:   - any value starting with 0x in the spec is returned as a hex string   - numeric values are returned as a quoted integer 
         * @summary Get spec params.
        ...
        async getSpec(options?: AxiosRequestConfig): Promise<AxiosResponse<GetSpecResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getSpec(options).then((request) => request(axios, basePath));
        },
        /**
         * Returns [Fork](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/phase0/beacon-chain.md#fork) object for state with given 'stateId'.
         * @summary Get Fork object for requested state
         ...
         * @throws {RequiredError}
         */
        async getStateFork(stateId: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetStateForkResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getStateFork(stateId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns validator specified by state and id or public key along with status and balance.
         * @summary Get validator from state by id
         ...
         * @throws {RequiredError}
         */
        async getStateValidator(stateId: any, validatorId: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetStateValidatorResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getStateValidator(stateId, validatorId, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests the beacon node to provide a set of sync committee duties for a particular epoch.
         * @summary Get sync committee duties
        ...
        async getSyncCommitteeDuties(body: any, epoch: any, options?: AxiosRequestConfig): Promise<AxiosResponse<GetSyncCommitteeDutiesResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getSyncCommitteeDuties(body, epoch, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests the beacon node to describe if it's currently syncing or not, and if it is, what block it is up to.
         * @summary Get node syncing status
        ...
        async getSyncingStatus(options?: AxiosRequestConfig): Promise<AxiosResponse<GetSyncingStatusResponse>> {
            return ValidatorRequiredApiApiFp(configuration).getSyncingStatus(options).then((request) => request(axios, basePath));
        },
        /**
         * After beacon node receives this request, search using discv5 for peers related to this subnet and replace current peers with those ones if necessary If validator `is_aggregator`, beacon node must: - announce subnet topic subscription on gossipsub - aggregate attestations received on that subnet 
         * @summary Signal beacon node to prepare for a committee subnet
        ...
        async prepareBeaconCommitteeSubnet(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).prepareBeaconCommitteeSubnet(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Prepares the beacon node for potential proposers by supplying information required when proposing blocks for the given validators.  The information supplied for each validator index will persist through the epoch in which the call is submitted and for a further two epochs after that, or until the beacon node restarts.  It is expected that validator clients will send this information periodically, for example each epoch, to ensure beacon nodes have correct and timely fee recipient information.  Note that there is no guarantee that the beacon node will use the supplied fee recipient when creating a block proposal, so on receipt of a proposed block the validator should confirm that it finds the fee recipient within the block acceptable before signing it.  Also note that requests containing currently inactive or unknown validator indices will be accepted, as they may become active at a later epoch. 
         * @summary Provide beacon node with proposals for the given validators.
        ...
        async prepareBeaconProposer(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).prepareBeaconProposer(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Subscribe to a number of sync committee subnets  Sync committees are not present in phase0, but are required for Altair networks.  Subscribing to sync committee subnets is an action performed by VC to enable network participation in Altair networks, and only required if the VC has an active validator in an active sync committee. 
         * @summary Subscribe to sync committee subnets
        ...
        async prepareSyncCommitteeSubnets(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).prepareSyncCommitteeSubnets(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests that the beacon node produce an AttestationData.  A 503 error must be returned if the block identified by the response `beacon_block_root` is optimistic (i.e. the attestation attests to a block that has not been fully verified by an execution engine). 
         * @summary Produce an attestation data
        ...
        async produceAttestationData(slot: any, committeeIndex: any, options?: AxiosRequestConfig): Promise<AxiosResponse<ProduceAttestationDataResponse>> {
            return ValidatorRequiredApiApiFp(configuration).produceAttestationData(slot, committeeIndex, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests a beacon node to produce a valid blinded block, which can then be signed by a validator.  A blinded block is a block with only a transactions root, rather than a full transactions list.  Metadata in the response indicates the type of block produced, and the supported types of block will be added to as forks progress.  Before Bellatrix, this endpoint will return a `BeaconBlock`. 
         * @summary Produce a new blinded block, without signature.
        ...
        async produceBlindedBlock(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<ProduceBlindedBlockResponse>> {
            return ValidatorRequiredApiApiFp(configuration).produceBlindedBlock(slot, randaoReveal, graffiti, skipRandaoVerification, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests a beacon node to produce a valid block, which can then be signed by a validator.  Metadata in the response indicates the type of block produced, and the supported types of block will be added to as forks progress. 
         * @summary Produce a new block, without signature.
        ...
        async produceBlockV2(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<ProduceBlockV2Response>> {
            return ValidatorRequiredApiApiFp(configuration).produceBlockV2(slot, randaoReveal, graffiti, skipRandaoVerification, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests a beacon node to produce a valid block, which can then be signed by a validator. The returned block may be blinded or unblinded, depending on the current state of the network as decided by the execution and beacon nodes.  The beacon node must return an unblinded block if it obtains the execution payload from its paired execution node. It must only return a blinded block if it obtains the execution payload header from an MEV relay.  Metadata in the response indicates the type of block produced, and the supported types of block will be added to as forks progress. 
         * @summary Produce a new block, without signature.
        ...
        async produceBlockV3(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, builderBoostFactor?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<ProduceBlockV3Response>> {
            return ValidatorRequiredApiApiFp(configuration).produceBlockV3(slot, randaoReveal, graffiti, skipRandaoVerification, builderBoostFactor, options).then((request) => request(axios, basePath));
        },
        /**
         * Requests that the beacon node produce a sync committee contribution.  A 503 error must be returned if the block identified by the response `beacon_block_root` is optimistic (i.e. the sync committee contribution refers to a block that has not been fully verified by an execution engine). 
         * @summary Produce a sync committee contribution
        ...
        async produceSyncCommitteeContribution(slot: any, subcommitteeIndex: any, beaconBlockRoot: any, options?: AxiosRequestConfig): Promise<AxiosResponse<ProduceSyncCommitteeContributionResponse>> {
            return ValidatorRequiredApiApiFp(configuration).produceSyncCommitteeContribution(slot, subcommitteeIndex, beaconBlockRoot, options).then((request) => request(axios, basePath));
        },
        /**
         * Verifies given aggregate and proofs and publishes them on appropriate gossipsub topic.
         * @summary Publish multiple aggregate and proofs
        ...
        async publishAggregateAndProofs(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).publishAggregateAndProofs(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Instructs the beacon node to use the components of the `SignedBlindedBeaconBlock` to construct and publish a  `SignedBeaconBlock` by swapping out the `transactions_root` for the corresponding full list of `transactions`. The beacon node should broadcast a newly constructed `SignedBeaconBlock` to the beacon network, to be included in the beacon chain. The beacon node is not required to validate the signed `BeaconBlock`, and a successful response (20X) only indicates that the broadcast has been successful. The beacon node is expected to integrate the new block into its state, and therefore validate the block internally, however blocks which fail the validation are still broadcast but a different status code is returned (202). Before Bellatrix, this endpoint will accept  a `SignedBeaconBlock`. 
         * @summary Publish a signed block.
         ...
         * @throws {RequiredError}
         */
        async publishBlindedBlock(body: any, ethConsensusVersion?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).publishBlindedBlock(body, ethConsensusVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Instructs the beacon node to use the components of the `SignedBlindedBeaconBlock` to construct and publish a  `SignedBeaconBlock` by swapping out the `transactions_root` for the corresponding full list of `transactions`. The beacon node should broadcast a newly constructed `SignedBeaconBlock` to the beacon network, to be included in the beacon chain. The beacon node is not required to validate the signed `BeaconBlock`, and a successful response (20X) only indicates that the broadcast has been successful. The beacon node is expected to integrate the new block into its state, and therefore validate the block internally, however blocks which fail the validation are still broadcast but a different status code is returned (202). Before Bellatrix, this endpoint will accept  a `SignedBeaconBlock`. 
         * @summary Publish a signed block.
         ...
         * @throws {RequiredError}
         */
        async publishBlindedBlockV2(body: any, ethConsensusVersion: any, broadcastValidation?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).publishBlindedBlockV2(body, ethConsensusVersion, broadcastValidation, options).then((request) => request(axios, basePath));
        },
        /**
         * Instructs the beacon node to use the components of the `SignedBlindedBeaconBlock` to construct and publish a  `SignedBeaconBlock` by swapping out the `transactions_root` for the corresponding full list of `transactions`. The beacon node should broadcast a newly constructed `SignedBeaconBlock` to the beacon network, to be included in the beacon chain. The beacon node is not required to validate the signed `BeaconBlock`, and a successful response (20X) only indicates that the broadcast has been successful. The beacon node is expected to integrate the new block into its state, and therefore validate the block internally, however blocks which fail the validation are still broadcast but a different status code is returned (202). Before Bellatrix, this endpoint will accept  a `SignedBeaconBlock`. The broadcast behaviour may be adjusted via the `broadcast_validation` query parameter. 
         * @summary Publish a signed block.
         ...
         * @throws {RequiredError}
         */
        async publishBlock(body: any, ethConsensusVersion?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).publishBlock(body, ethConsensusVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Instructs the beacon node to broadcast a newly signed beacon block to the beacon network, to be included in the beacon chain. A success response (20x) indicates that the block passed gossip validation and was successfully broadcast onto the network. The beacon node is also expected to integrate the block into state, but may broadcast it before doing so, so as to aid timely delivery of the block. Should the block fail full validation, a separate success response code (202) is used to indicate that the block was successfully broadcast but failed integration. After Deneb, this additionally instructs the beacon node to broadcast all given blobs. 
         * @summary Publish a signed block.
         ...
         * @throws {RequiredError}
         */
        async publishBlockV2(body: any, ethConsensusVersion: any, broadcastValidation?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).publishBlockV2(body, ethConsensusVersion, broadcastValidation, options).then((request) => request(axios, basePath));
        },
        /**
         * Instructs the beacon node to broadcast a newly signed beacon block to the beacon network, to be included in the beacon chain. A success response (20x) indicates that the block passed gossip validation and was successfully broadcast onto the network. The beacon node is also expected to integrate the block into the state, but may broadcast it before doing so, so as to aid timely delivery of the block. Should the block fail full validation, a separate success response code (202) is used to indicate that the block was successfully broadcast but failed integration. After Deneb, this additionally instructs the beacon node to broadcast all given blobs. The broadcast behaviour may be adjusted via the `broadcast_validation` query parameter. 
         * @summary Publish a signed block.
        ...
        async publishContributionAndProofs(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).publishContributionAndProofs(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Submits Attestation objects to the node.  Each attestation in the request body is processed individually.  If an attestation is validated successfully the node MUST publish that attestation on the appropriate subnet.  If one or more attestations fail validation the node MUST return a 400 error with details of which attestations have failed, and why. 
         * @summary Submit Attestation objects to node
         ...
         * @throws {RequiredError}
         */
        async submitPoolAttestations(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).submitPoolAttestations(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Submits sync committee signature objects to the node.  Sync committee signatures are not present in phase0, but are required for Altair networks.  If a sync committee signature is validated successfully the node MUST publish that sync committee signature on all applicable subnets.  If one or more sync committee signatures fail validation the node MUST return a 400 error with details of which sync committee signatures have failed, and why. 
         * @summary Submit sync committee signatures to node
         ...
         * @throws {RequiredError}
         */
        async submitPoolSyncCommitteeSignatures(body: any, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return ValidatorRequiredApiApiFp(configuration).submitPoolSyncCommitteeSignatures(body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ValidatorRequiredApiApi extends BaseAPI {
    ...
    public async eventstream(topics: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<any>> {
        return ValidatorRequiredApiApiFp(this.configuration).eventstream(topics, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Aggregates all attestations matching given attestation data root and slot.  A 503 error must be returned if the block identified by the response `beacon_block_root` is optimistic (i.e. the aggregated attestation attests to a block that has not been fully verified by an execution engine).  A 404 error must be returned if no attestation is available for the requested `attestation_data_root`. 
     * @summary Get aggregated attestation
    ...
    public async getAggregatedAttestation(attestationDataRoot: any, slot: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetAggregatedAttestationResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getAggregatedAttestation(attestationDataRoot, slot, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests the beacon node to provide a set of attestation duties, which should be performed by validators, for a particular epoch. Duties should only need to be checked once per epoch, however a chain reorganization (of > MIN_SEED_LOOKAHEAD epochs) could occur, resulting in a change of duties. For full safety, you should monitor head events and confirm the dependent root in this response matches: - event.previous_duty_dependent_root when `compute_epoch_at_slot(event.slot) == epoch` - event.current_duty_dependent_root when `compute_epoch_at_slot(event.slot) + 1 == epoch` - event.block otherwise  The dependent_root value is `get_block_root_at_slot(state, compute_start_slot_at_epoch(epoch - 1) - 1)` or the genesis block root in the case of underflow.
     * @summary Get attester duties
    ...
    public async getAttesterDuties(body: any, epoch: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetAttesterDutiesResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getAttesterDuties(body, epoch, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve details of the chain's genesis which can be used to identify chain.
     * @summary Retrieve details of the chain's genesis.
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async getGenesis(options?: AxiosRequestConfig) : Promise<AxiosResponse<GetGenesisResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getGenesis(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Request beacon node to provide all validators that are scheduled to propose a block in the given epoch. Duties should only need to be checked once per epoch, however a chain reorganization could occur that results in a change of duties. For full safety, you should monitor head events and confirm the dependent root in this response matches: - event.current_duty_dependent_root when `compute_epoch_at_slot(event.slot) == epoch` - event.block otherwise  The dependent_root value is `get_block_root_at_slot(state, compute_start_slot_at_epoch(epoch) - 1)` or the genesis block root in the case of underflow.
     * @summary Get block proposers duties
    ...
    public async getProposerDuties(epoch: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetProposerDutiesResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getProposerDuties(epoch, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve specification configuration used on this node.  The configuration should include:   - Constants for all hard forks known by the beacon node, for example the [phase 0](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/phase0/beacon-chain.md#constants) and [altair](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/altair/beacon-chain.md#constants) values   - Presets for all hard forks supplied to the beacon node, for example the [phase 0](https://github.com/ethereum/consensus-specs/blob/v1.3.0/presets/mainnet/phase0.yaml) and [altair](https://github.com/ethereum/consensus-specs/blob/v1.3.0/presets/mainnet/altair.yaml) values   - Configuration for the beacon node, for example the [mainnet](https://github.com/ethereum/consensus-specs/blob/v1.3.0/configs/mainnet.yaml) values  Values are returned with following format:   - any value starting with 0x in the spec is returned as a hex string   - numeric values are returned as a quoted integer 
     * @summary Get spec params.
    ...
    public async getSpec(options?: AxiosRequestConfig) : Promise<AxiosResponse<GetSpecResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getSpec(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns [Fork](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/phase0/beacon-chain.md#fork) object for state with given 'stateId'.
     * @summary Get Fork object for requested state
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async getStateFork(stateId: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetStateForkResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getStateFork(stateId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns validator specified by state and id or public key along with status and balance.
     * @summary Get validator from state by id
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async getStateValidator(stateId: any, validatorId: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetStateValidatorResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getStateValidator(stateId, validatorId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests the beacon node to provide a set of sync committee duties for a particular epoch.
     * @summary Get sync committee duties
    ...
    public async getSyncCommitteeDuties(body: any, epoch: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<GetSyncCommitteeDutiesResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getSyncCommitteeDuties(body, epoch, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests the beacon node to describe if it's currently syncing or not, and if it is, what block it is up to.
     * @summary Get node syncing status
    ...
    public async getSyncingStatus(options?: AxiosRequestConfig) : Promise<AxiosResponse<GetSyncingStatusResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).getSyncingStatus(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * After beacon node receives this request, search using discv5 for peers related to this subnet and replace current peers with those ones if necessary If validator `is_aggregator`, beacon node must: - announce subnet topic subscription on gossipsub - aggregate attestations received on that subnet 
     * @summary Signal beacon node to prepare for a committee subnet
    ...
    public async prepareBeaconCommitteeSubnet(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).prepareBeaconCommitteeSubnet(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Prepares the beacon node for potential proposers by supplying information required when proposing blocks for the given validators.  The information supplied for each validator index will persist through the epoch in which the call is submitted and for a further two epochs after that, or until the beacon node restarts.  It is expected that validator clients will send this information periodically, for example each epoch, to ensure beacon nodes have correct and timely fee recipient information.  Note that there is no guarantee that the beacon node will use the supplied fee recipient when creating a block proposal, so on receipt of a proposed block the validator should confirm that it finds the fee recipient within the block acceptable before signing it.  Also note that requests containing currently inactive or unknown validator indices will be accepted, as they may become active at a later epoch. 
     * @summary Provide beacon node with proposals for the given validators.
    ...
    public async prepareBeaconProposer(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).prepareBeaconProposer(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Subscribe to a number of sync committee subnets  Sync committees are not present in phase0, but are required for Altair networks.  Subscribing to sync committee subnets is an action performed by VC to enable network participation in Altair networks, and only required if the VC has an active validator in an active sync committee. 
     * @summary Subscribe to sync committee subnets
    ...
    public async prepareSyncCommitteeSubnets(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).prepareSyncCommitteeSubnets(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests that the beacon node produce an AttestationData.  A 503 error must be returned if the block identified by the response `beacon_block_root` is optimistic (i.e. the attestation attests to a block that has not been fully verified by an execution engine). 
     * @summary Produce an attestation data
    ...
    public async produceAttestationData(slot: any, committeeIndex: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<ProduceAttestationDataResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).produceAttestationData(slot, committeeIndex, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests a beacon node to produce a valid blinded block, which can then be signed by a validator.  A blinded block is a block with only a transactions root, rather than a full transactions list.  Metadata in the response indicates the type of block produced, and the supported types of block will be added to as forks progress.  Before Bellatrix, this endpoint will return a `BeaconBlock`. 
     * @summary Produce a new blinded block, without signature.
    ...
    public async produceBlindedBlock(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<ProduceBlindedBlockResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).produceBlindedBlock(slot, randaoReveal, graffiti, skipRandaoVerification, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests a beacon node to produce a valid block, which can then be signed by a validator.  Metadata in the response indicates the type of block produced, and the supported types of block will be added to as forks progress. 
     * @summary Produce a new block, without signature.
    ...
    public async produceBlockV2(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<ProduceBlockV2Response>> {
        return ValidatorRequiredApiApiFp(this.configuration).produceBlockV2(slot, randaoReveal, graffiti, skipRandaoVerification, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests a beacon node to produce a valid block, which can then be signed by a validator. The returned block may be blinded or unblinded, depending on the current state of the network as decided by the execution and beacon nodes.  The beacon node must return an unblinded block if it obtains the execution payload from its paired execution node. It must only return a blinded block if it obtains the execution payload header from an MEV relay.  Metadata in the response indicates the type of block produced, and the supported types of block will be added to as forks progress. 
     * @summary Produce a new block, without signature.
    ...
    public async produceBlockV3(slot: any, randaoReveal: any, graffiti?: any, skipRandaoVerification?: any, builderBoostFactor?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<ProduceBlockV3Response>> {
        return ValidatorRequiredApiApiFp(this.configuration).produceBlockV3(slot, randaoReveal, graffiti, skipRandaoVerification, builderBoostFactor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Requests that the beacon node produce a sync committee contribution.  A 503 error must be returned if the block identified by the response `beacon_block_root` is optimistic (i.e. the sync committee contribution refers to a block that has not been fully verified by an execution engine). 
     * @summary Produce a sync committee contribution
    ...
    public async produceSyncCommitteeContribution(slot: any, subcommitteeIndex: any, beaconBlockRoot: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<ProduceSyncCommitteeContributionResponse>> {
        return ValidatorRequiredApiApiFp(this.configuration).produceSyncCommitteeContribution(slot, subcommitteeIndex, beaconBlockRoot, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Verifies given aggregate and proofs and publishes them on appropriate gossipsub topic.
     * @summary Publish multiple aggregate and proofs
    ...
    public async publishAggregateAndProofs(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).publishAggregateAndProofs(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Instructs the beacon node to use the components of the `SignedBlindedBeaconBlock` to construct and publish a  `SignedBeaconBlock` by swapping out the `transactions_root` for the corresponding full list of `transactions`. The beacon node should broadcast a newly constructed `SignedBeaconBlock` to the beacon network, to be included in the beacon chain. The beacon node is not required to validate the signed `BeaconBlock`, and a successful response (20X) only indicates that the broadcast has been successful. The beacon node is expected to integrate the new block into its state, and therefore validate the block internally, however blocks which fail the validation are still broadcast but a different status code is returned (202). Before Bellatrix, this endpoint will accept  a `SignedBeaconBlock`. 
     * @summary Publish a signed block.
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async publishBlindedBlock(body: any, ethConsensusVersion?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).publishBlindedBlock(body, ethConsensusVersion, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async publishBlindedBlockV2(body: any, ethConsensusVersion: any, broadcastValidation?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).publishBlindedBlockV2(body, ethConsensusVersion, broadcastValidation, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async publishBlock(body: any, ethConsensusVersion?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).publishBlock(body, ethConsensusVersion, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async publishBlockV2(body: any, ethConsensusVersion: any, broadcastValidation?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).publishBlockV2(body, ethConsensusVersion, broadcastValidation, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public async publishContributionAndProofs(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).publishContributionAndProofs(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Submits Attestation objects to the node.  Each attestation in the request body is processed individually.  If an attestation is validated successfully the node MUST publish that attestation on the appropriate subnet.  If one or more attestations fail validation the node MUST return a 400 error with details of which attestations have failed, and why. 
     * @summary Submit Attestation objects to node
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async submitPoolAttestations(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).submitPoolAttestations(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Submits sync committee signature objects to the node.  Sync committee signatures are not present in phase0, but are required for Altair networks.  If a sync committee signature is validated successfully the node MUST publish that sync committee signature on all applicable subnets.  If one or more sync committee signatures fail validation the node MUST return a 400 error with details of which sync committee signatures have failed, and why. 
     * @summary Submit sync committee signatures to node
     ...
     * @memberof ValidatorRequiredApiApi
     */
    public async submitPoolSyncCommitteeSignatures(body: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return ValidatorRequiredApiApiFp(this.configuration).submitPoolSyncCommitteeSignatures(body, options).then((request) => request(this.axios, this.basePath));
    }
}
