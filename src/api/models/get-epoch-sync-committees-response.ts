...
import { GetEpochSyncCommitteesResponseData } from './get-epoch-sync-committees-response-data';
 /**
 * 
 *
 * @export
 * @interface GetEpochSyncCommitteesResponse
 */
export interface GetEpochSyncCommitteesResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetEpochSyncCommitteesResponse
     * @example false
     */
    ...
    /**
     * @type {GetEpochSyncCommitteesResponseData}
     * @memberof GetEpochSyncCommitteesResponse
     */
    data: GetEpochSyncCommitteesResponseData;
}
