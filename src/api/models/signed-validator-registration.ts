...
import { SignedValidatorRegistrationMessage } from './signed-validator-registration-message';
 /**
 * The `SignedValidatorRegistration` object from the Builder API specification.
 *
 * @export
 * @interface SignedValidatorRegistration
 */
export interface SignedValidatorRegistration {

    /**
     * @type {SignedValidatorRegistrationMessage}
     * @memberof SignedValidatorRegistration
     */
