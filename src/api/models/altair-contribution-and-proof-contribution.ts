 ...
 *
 * @export
 * @interface AltairContributionAndProofContribution
 */
export interface AltairContributionAndProofContribution {

    /**
     * The slot at which the validator is providing a sync committee contribution.
     *
     * @type {any}
     * @memberof AltairContributionAndProofContribution
     * @example 1
     */
    slot: any;
