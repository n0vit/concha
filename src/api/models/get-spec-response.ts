...
export interface GetSpecResponse {
    ...
    /**
     * Key value mapping of all constants, presets and configuration values for all known hard forks Values are returned with following format:   - any value starting with 0x in the spec is returned as a hex string   - numeric values are returned as a quoted integer 
     *
     * @type {any}
     * @memberof GetSpecResponse
     * @example {"DEPOSIT_CONTRACT_ADDRESS":"0x00000000219ab540356cBB839Cbe05303d7705Fa","DEPOSIT_NETWORK_ID":"1","DOMAIN_AGGREGATE_AND_PROOF":"0x06000000","INACTIVITY_PENALTY_QUOTIENT":"67108864","INACTIVITY_PENALTY_QUOTIENT_ALTAIR":"50331648"}
     */
    data: any;
}
