...
import { GetDepositSnapshotResponseData } from './get-deposit-snapshot-response-data';
 /**
 * 
 *
 * @export
 * @interface GetDepositSnapshotResponse
 */
export interface GetDepositSnapshotResponse {

    /**
     * @type {GetDepositSnapshotResponseData}
     * @memberof GetDepositSnapshotResponse
     */
    data: GetDepositSnapshotResponseData;
}
