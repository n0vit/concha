...
import { AltairLightClientBootstrapHeader } from './altair-light-client-bootstrap-header';
import { AltairLightClientUpdateSyncAggregate } from './altair-light-client-update-sync-aggregate';
 /**
 * 
 *
 * @export
 * @interface AltairLightClientUpdate
 */
export interface AltairLightClientUpdate {

    /**
     * @type {AltairLightClientBootstrapHeader}
     * @memberof AltairLightClientUpdate
     */
    attestedHeader: AltairLightClientBootstrapHeader;
     ...
     * @memberof AltairLightClientUpdate
     */
    finalizedHeader: AltairLightClientBootstrapHeader;
