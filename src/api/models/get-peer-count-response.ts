...
import { GetPeerCountResponseData } from './get-peer-count-response-data';
 /**
 * 
 *
 * @export
 * @interface GetPeerCountResponse
 */
export interface GetPeerCountResponse {

    /**
     * @type {GetPeerCountResponseData}
     * @memberof GetPeerCountResponse
     */
    data: GetPeerCountResponseData;
}
