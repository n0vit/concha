...
import { GetStateRootResponseData } from './get-state-root-response-data';
 /**
 * 
 *
 * @export
 * @interface GetStateRootResponse
 */
export interface GetStateRootResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetStateRootResponse
     * @example false
     */
