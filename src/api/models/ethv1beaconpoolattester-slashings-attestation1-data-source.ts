 ...
 */
 ...
 /**
 * The [`Checkpoint`](https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/phase0/beacon-chain.md#checkpoint
 *
 * @export
 * @interface Ethv1beaconpoolattesterSlashingsAttestation1DataSource
 */
export interface Ethv1beaconpoolattesterSlashingsAttestation1DataSource {

    /**
     * @type {any}
     * @memberof Ethv1beaconpoolattesterSlashingsAttestation1DataSource
     * @example 1
     */
    epoch: any;
