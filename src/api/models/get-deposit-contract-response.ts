...
import { GetDepositContractResponseData } from './get-deposit-contract-response-data';
 /**
 * 
 *
 * @export
 * @interface GetDepositContractResponse
 */
export interface GetDepositContractResponse {

    /**
     * @type {GetDepositContractResponseData}
     * @memberof GetDepositContractResponse
     */
    data: GetDepositContractResponseData;
}
