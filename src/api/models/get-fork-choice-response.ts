 ...
 *
 * @export
 * @interface GetForkChoiceResponse
 */
export interface GetForkChoiceResponse {

    /**
     * @type {Ethv1beaconpoolattesterSlashingsAttestation1DataSource}
     * @memberof GetForkChoiceResponse
     */
    justifiedCheckpoint: Ethv1beaconpoolattesterSlashingsAttestation1DataSource;
