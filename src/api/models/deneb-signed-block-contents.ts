...
import { DenebSignedBlockContentsSignedBlock } from './deneb-signed-block-contents-signed-block';
 /**
 * The required signed components of block production according to the Deneb CL spec.
 *
 * @export
 * @interface DenebSignedBlockContents
 */
export interface DenebSignedBlockContents {

    /**
     * @type {DenebSignedBlockContentsSignedBlock}
     * @memberof DenebSignedBlockContents
     */
    signedBlock: DenebSignedBlockContentsSignedBlock;
