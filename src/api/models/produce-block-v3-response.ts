 ...
 *
 * @export
 * @interface ProduceBlockV3Response
 */
export interface ProduceBlockV3Response {

    /**
     * @type {any}
     * @memberof ProduceBlockV3Response
     * @example phase0
     */
    version: any;
