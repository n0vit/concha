 ...
 *
 * @export
 * @interface SignedBLSToExecutionChangeMessage
 */
export interface SignedBLSToExecutionChangeMessage {

    /**
     * Index of the validator for which credentials will be changed.
     *
     * @type {any}
     * @memberof SignedBLSToExecutionChangeMessage
     * @example 1
     */
    validatorIndex: any;
