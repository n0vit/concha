 ...
 *
 * @export
 * @interface GetEpochSyncCommitteesResponseData
 */
export interface GetEpochSyncCommitteesResponseData {

    /**
     * all of the validator indices in the current sync committee
     *
     * @type {any}
     * @memberof GetEpochSyncCommitteesResponseData
     */
    validators: any;
