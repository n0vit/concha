 ...
 *
 * @export
 * @interface AltairLightClientBootstrap
 */
export interface AltairLightClientBootstrap {

    /**
     * @type {AltairLightClientBootstrapHeader}
     * @memberof AltairLightClientBootstrap
     */
    header: AltairLightClientBootstrapHeader;
