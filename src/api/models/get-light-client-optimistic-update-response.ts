 ...
 *
 * @export
 * @interface GetLightClientOptimisticUpdateResponse
 */
export interface GetLightClientOptimisticUpdateResponse {

    /**
     * @type {any}
     * @memberof GetLightClientOptimisticUpdateResponse
     * @example phase0
     */
    version: any;
