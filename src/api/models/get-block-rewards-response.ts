...
import { GetBlockRewardsResponseData } from './get-block-rewards-response-data';
 /**
 * 
 *
 * @export
 * @interface GetBlockRewardsResponse
 */
export interface GetBlockRewardsResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetBlockRewardsResponse
     * @example false
     */
    ...
    /**
     * @type {GetBlockRewardsResponseData}
     * @memberof GetBlockRewardsResponse
     */
    data: GetBlockRewardsResponseData;
}
