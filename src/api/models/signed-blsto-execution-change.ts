...
import { SignedBLSToExecutionChangeMessage } from './signed-blsto-execution-change-message';
 /**
...
export interface SignedBLSToExecutionChange {
    ...
    /**
     * @type {SignedBLSToExecutionChangeMessage}
     * @memberof SignedBLSToExecutionChange
     */
    message: SignedBLSToExecutionChangeMessage;
