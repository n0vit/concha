...
import { GetBlockRootResponseData } from './get-block-root-response-data';
 /**
 * 
 *
 * @export
 * @interface GetBlockRootResponse
 */
export interface GetBlockRootResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetBlockRootResponse
     * @example false
     */
