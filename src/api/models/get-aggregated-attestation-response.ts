...
import { GetAggregatedAttestationResponseData } from './get-aggregated-attestation-response-data';
 /**
 * 
 *
 * @export
 * @interface GetAggregatedAttestationResponse
 */
export interface GetAggregatedAttestationResponse {

    /**
     * @type {GetAggregatedAttestationResponseData}
     * @memberof GetAggregatedAttestationResponse
     */
    data: GetAggregatedAttestationResponseData;
}
