...
import { GetBlockHeaderResponseData } from './get-block-header-response-data';
 /**
 * 
 *
 * @export
...
export interface GetBlockHeaderResponse {
     ...
     *
     * @type {any}
     * @memberof GetBlockHeaderResponse
     * @example false
     */
    ...
    /**
     * @type {GetBlockHeaderResponseData}
     * @memberof GetBlockHeaderResponse
     */
    data: GetBlockHeaderResponseData;
}
