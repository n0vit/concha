...
import { GetStateValidatorResponseData } from './get-state-validator-response-data';
 /**
 * 
 *
 * @export
 * @interface GetStateValidatorResponse
 */
export interface GetStateValidatorResponse {

    /**
     * True if the response references an unverified execution payload. Optimistic information may be invalidated at a later time. If the field is not present, assume the False value.
     *
     * @type {any}
     * @memberof GetStateValidatorResponse
     * @example false
     */
    ...
    /**
     * @type {GetStateValidatorResponseData}
     * @memberof GetStateValidatorResponse
     */
    data: GetStateValidatorResponseData;
}
