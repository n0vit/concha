  ...
  return {
    ...
    getLiveness: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling getLiveness."
        );
      }
      // verify required parameter 'epoch' is not null or undefined
      if (epoch === null || epoch === undefined) {
        throw new RequiredError(
          "epoch",
          "Required parameter epoch was null or undefined when calling getLiveness."
        );
      }
      const localVarPath = `/eth/v1/validator/liveness/{epoch}`.replace(
        `{${"epoch"}}`,
        encodeURIComponent(String(epoch))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    registerValidator: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling registerValidator."
        );
      }
     ...
     * @throws {RequiredError}
     */
    submitBeaconCommitteeSelections: async (
      body: any,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'body' is not null or undefined
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling submitBeaconCommitteeSelections."
        );
      }
     ...
     * @throws {RequiredError}
     */
    submitSyncCommitteeSelections: async (
      body: any,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'body' is not null or undefined
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling submitSyncCommitteeSelections."
        );
      }
...
export const ValidatorApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await ValidatorApiAxiosParamCreator(
        configuration
    ...
    async getLiveness(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => Promise<AxiosResponse<PostLivenessResponseBody>>
    > {
      const localVarAxiosArgs = await ValidatorApiAxiosParamCreator(
        configuration
      ).getLiveness(body, epoch, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    > {
      const localVarAxiosArgs = await ValidatorApiAxiosParamCreator(
        configuration
      ).registerValidator(body, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    async submitBeaconCommitteeSelections(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => Promise<AxiosResponse<BeaconCommitteeSelectionResponse>>
    > {
      const localVarAxiosArgs = await ValidatorApiAxiosParamCreator(
        configuration
      ).submitBeaconCommitteeSelections(body, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    async submitSyncCommitteeSelections(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => Promise<AxiosResponse<SyncCommitteeSelectionResponse>>
    > {
      const localVarAxiosArgs = await ValidatorApiAxiosParamCreator(
        configuration
      ).submitSyncCommitteeSelections(body, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
...
export const ValidatorApiFactory = function (
  ...
  return {
    ...
    async getAggregatedAttestation(
      ...
      return ValidatorApiFp(configuration)
        .getAggregatedAttestation(attestationDataRoot, slot, options)
...
export class ValidatorApi extends BaseAPI {
   ...
   * @memberof ValidatorApi
   */
  public async submitBeaconCommitteeSelections(
    body: any,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<BeaconCommitteeSelectionResponse>> {
    return ValidatorApiFp(this.configuration)
   ...
   * @memberof ValidatorApi
   */
  public async submitSyncCommitteeSelections(
    body: any,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<SyncCommitteeSelectionResponse>> {
    return ValidatorApiFp(this.configuration)
