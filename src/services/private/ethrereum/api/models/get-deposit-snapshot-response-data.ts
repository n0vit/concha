 ...
 *
 * @export
 * @interface GetDepositSnapshotResponseData
 */
export interface GetDepositSnapshotResponseData {

    /**
     * @type {any}
     * @memberof GetDepositSnapshotResponseData
     */
    finalized: any;
