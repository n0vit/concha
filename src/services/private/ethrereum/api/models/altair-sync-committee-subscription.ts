 ...
 *
 * @export
 * @interface AltairSyncCommitteeSubscription
 */
export interface AltairSyncCommitteeSubscription {

    /**
     * @type {any}
     * @memberof AltairSyncCommitteeSubscription
     * @example 1
     */
    validatorIndex: any;
