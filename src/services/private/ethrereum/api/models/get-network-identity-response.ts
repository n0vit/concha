...
import { GetNetworkIdentityResponseData } from './get-network-identity-response-data';
 /**
 * 
 *
 * @export
 * @interface GetNetworkIdentityResponse
 */
export interface GetNetworkIdentityResponse {

    /**
     * @type {GetNetworkIdentityResponseData}
     * @memberof GetNetworkIdentityResponse
     */
    data: GetNetworkIdentityResponseData;
}
